...
import android.zj.com.zjmine.base.MyApplication;
...
public class HttpUtil {
    ...
    public static <T> T getRetrofit(final Class<T> service) {
        ...
        CommonHeaderInterceptor commonHeaderInterceptor = new CommonHeaderInterceptor(MyApplication.getGlobalContext());
