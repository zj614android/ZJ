...
import com.zjandroid.nani.dagger.component.DaggerGlobalComponent;
import com.zjandroid.nani.dagger.component.GlobalComponent;
...
public class NaNiApplication extends Application {
    ...
    private String TAG = "NaNiApplication";
...
//                .setAutoAdaptStrategy(new AutoAdaptStrategy())
     ...
     * {@link } 接口的方式来提供自定义适配参数 (因为远程依赖改不了源码)
     * 所以使用 {@link } 来替代实现接口的方式, 来提供自定义适配参数
     */
